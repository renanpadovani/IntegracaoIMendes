...
namespace IntegracaoIMendes.Dominio.Servicos
{
    public class ProcessamentoCenariosServico
    {
        ...
        public void ProcessarCenarios(Int64 produtoId = 0, string tipoClassificacaoProdutos = "")
        {
            ...
            List<Produtos> listaProdutos = CarregarProdutosParaIntegracao(produtoId, tipoClassificacaoProdutos);
