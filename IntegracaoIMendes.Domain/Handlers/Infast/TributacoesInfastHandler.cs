...
{
    public class TributacoesInfastHandler
    {
        private readonly TributacoesRepositorio _repositorio;
        private List<Produtos> _listaProdutos;

        public TributacoesInfastHandler(TributacoesRepositorio repositorio)
        {
